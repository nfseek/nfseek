...
const SetupPixaURL = () => {
    return (
            <>
                <div className={styles.page_full_handle}>
                    <div className="pu_container">
                        <div className={styles.pu_wr}>
                            <h3 className={styles.page_heading}>Setup NFSEEK</h3>
                ...
                <div className="pu_container">
                    <div className={`${styles.help_main} ${styles.pu_setup_pixaurl}`}> 
                        <Link href="/help/setup-pixaurl/create-pixaurl">Create NFSEEK</Link>
                        <Link href="/help/setup-pixaurl/rename-pixaurl">How to Rename NFSEEK</Link>
                        <Link href="/help/setup-pixaurl/edit-pixaurl">How to Edit my NFSEEK</Link>
                    </div>
                </div>
