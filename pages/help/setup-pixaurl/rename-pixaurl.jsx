...
const renamePixaurl = () => {
    ...
    <>  
            <div className={styles.page_full_handle}>
                <div className="pu_container">
                    <div className={styles.pu_wr}>
                        <h3 className={styles.page_heading}>Rename NFSEEK </h3>
            ...
            <div className="pu_container">
                <div>
                    <p>rename NFSEEK is simply dummy text of the printing and typesetting industry.
