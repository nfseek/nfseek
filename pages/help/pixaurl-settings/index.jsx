     ...
     <>
        <div className={styles.page_full_handle}>
            <div className="pu_container">
                <div className={styles.pu_wr}>
                    <h3 className={styles.page_heading}>NFSEEK Settings</h3>
        ...
        <div className="pu_container">
            <div className={`${styles.help_main} ${styles.pu_pixaurl_settings}`}> 
                <Link href="/help/pixaurl-settings/customize-theme"><a>How to customize NFSEEK theme</a></Link>
                ...
                <Link href="/help/pixaurl-settings/change-template"><a>How to change NFSEEK template</a></Link>
                <Link href="/help/pixaurl-settings/seo-settings"><a>NFSEEK SEO settings</a></Link>
            </div>
        </div>
        </>
