...
const Home = () => {
  ...
  useEffect(() => {
    ...
    new Typewriter('#type_anim', {
      ...
      strings: ['Mini Website', 'Bio Link', 'Portfolio Site', 'Social Link' , 'Personal URL', 'NFSEEK', 'Pro Bio URL'],
      autoStart: true,
      loop: true
    });
