    ...
    return (
        <>
                        ...
                        {editorHeaderStatus === false ?
                                    ...
                                    <ul>
                                        {tokenData?.role === 2 ?
                                            <>
                                                ...
                                                <li className={styles.nav_dropdown}>
                                                    <a className={isActive('/myqr') || isActive('/qr-generator') || isActive('/leaderboard')}>Analytics</a>
                            ...
                            <>
                                ...
                                <div className={styles.header_right_action + ' ' + styles.editor_header_right}>
                                    ...
                                    <button 
                                        className={"pu_btn pu_btn_secondary " + styles.pu_btn} 
                                        onClick={() => setIsAttachQRModalOpen(true)}
                                    >
            ...
            <AttachQRModal 
                ...
                onClose={() => setIsAttachQRModalOpen(false)}
                profileUrl={process.env.APP_URL + (props.editor.editorData ? props.editor.editorData.slug : '')}
            />
        </>
    );
}
